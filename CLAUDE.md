...
- Current Sprint: Capabl.app Clipper (Chrome Extension MV3).

## Quick Start
```
git clone https://github.com/IITOKSII/capabl-app && cd capabl-app
...
3. **Plan Gate** — removed for Capabl.app (2026-03-16). Full autonomy authorized.
...
2. git add + commit -> "Capabl.app Update: {date}"
